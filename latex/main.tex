...
% ========================================================================
    \begin{resumo}[Abstract]
        \begin{otherlanguage*}{english}
            ...
            \textbf{Key-words}: Natural Language Processing. Information Retrieval. Legal Search. TF-IDF. BM25. Embeddings.
        \end{otherlanguage*}
    \end{resumo}
...
% (Esta seção foi mantida como estava, pois já era muito boa)
    ...
    \subsection{A Consolidação do BM25 (Robertson et al., 1995)}
    ...
    \subsection{Eficiência em Representações Vetoriais (Mikolov et al., 2013)}
    ...
    \subsection{Comparação no Domínio Jurídico Brasileiro (Santos, 2023)}
