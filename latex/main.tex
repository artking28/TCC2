...
for key := range tf {
    ...
    Para os algoritmos estatísticos, o sistema utiliza um índice invertido persistido em um banco de dados SQLite via GORM. A implementação dos cálculos de TF-IDF e Okapi BM25 ocorre no pacote \texttt{utils}.
